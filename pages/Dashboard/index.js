...
const DOM = {
  ...
  innerHTMLTransaction(transaction, index) {
    ...
    const html = `
      ...
      <td>
          <img onclick="Transaction.remove(${index})" src="assests/x-circle.svg" class="remove-transaction" alt="Remover transaction">
      </td> `;
    return html;
  },
...
const Utils = {
  ...
  formatCurrency(value) {
    ...
    // Formatting value to Indian Rupees (Rs) format
    value = Number(value) / 100;
